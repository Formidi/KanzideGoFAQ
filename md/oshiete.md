...
[楷書MCBK1](https://sankoufont.com/japanese-font/kaishomcbk1/)については特徴的な形状をしており、非対応パーツを製作する場合にとめ／はね／はらいを予測するためのコストが高くなってしまいます。
...
### それでも時間をかけてやればいいのでは？
別のゲーム開発を長期的に計画しているため、漢字でGO!だけに時間を割けない状況です。
