...
ゲームの一部画像を使用して動画を製作し、それを公開することは問題ございません。
...
## なぜ出題時フォントが『セイビタカナワ』？
比較的対応している字体が多くリーズナブルで、ほか楷書フォントと比べてシンプルで加工しやすい形状であったためです。

</br>

### 『楷書MCBK1』の方がそれっぽくなるし、字体が多く対応していて経済的では？
UIをご覧いただければ分かる通り、**特定のフォントに一致させる意図はありません。**また、出題時の漢字レイアウトは本作の核となる設計箇所であり、安易にそのスタイルを変更することができないため、現在のフォント構成を採用しております。

また、[楷書MCBK1](https://sankoufont.com/japanese-font/kaishomcbk1/)は特徴的な形状をしており、非対応パーツを製作する場合にとめ／はね／はらいを予測するためのコストが高くなってしまいます。

対応字体が多いといえども、やはり高難易度で出題されるUnicodeの多くは非対応であり、

</br>

![こういうの①](./images/oshiete_kanzi01.png)  
こういうのや、

![こういうの②](./images/oshiete_kanzi02.png)  
こういうのを再びイチから作り直すのはおよそ現実的ではございません。

率直に申し上げますと、**[Unicode非対応の文字でさえもすべて収録している、シンプルで編集しやすい楷書フォント](https://kotowaza.jitenon.jp/kotowaza/1353.php)**でないと割に合わないです…
...
### ピカタブD51
ピカピカ(擬音) + タブレット + 開発中(**D**eveloping) + <strong class="strong large">新ステージを制作中、強烈なめまいが来た回数(5) + 意識を失いかけるレベルの腹痛が来た回数(1)</strong>
