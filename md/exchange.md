...
1.0.7βをもちまして、<strong class="strong large">本ページの更新を終了いたします。</strong><span class="small">（差し替えのたびに工数が掛かる反面、そこまで需要を感じられないため）</span>

### 『どうしても知りたい！』という方へ
- 有志のサイトをご覧になるか、[diffツール](https://notepm.jp/blog/6725)などを使用して過去バージョンとのデータ比較をされることをお勧めいたします。使い方はご自身で調べてください。
- 今後、メインの問題を全て見られるような機能を検討中です。
