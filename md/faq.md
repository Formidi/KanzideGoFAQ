<!-- よくある質問（FAQ） -->
# 重要
<strong class="strong large">有志の方から製作していただいた一部プラグインの使用を制限する旨のご連絡があったため、ブラウザ版など各プラットフォームにおきまして一時工事中とさせていただきます。</strong>
[詳細に関してはこちら](https://twitter.com/KanzideGo/status/1767527565705781487)
...
リクエストを請けるモチベーションがないため、実装する優先度は低めです。
...
いくら要望が来たとしてもこちらが**趣味で**公開しているゲームですので、有償で請けることも厳しいです。
