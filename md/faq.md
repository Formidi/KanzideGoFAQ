...
ジャンルの優先度に関しては以下の通りです。たまに例外[^2]が出る時もありますが、**基本的に開発側の裁量**といたします。
[^2]:Lv3『魔剤』は「スラング」としている。以下の表を基準とするならば「飲食」に入りそうではあるが、そもそも『魔剤』という単語そのものが俗語であり、仮に「飲食」ジャンルとすると『魔剤』を俗語ではないものと見なすことになる
...
タイムワープを追加して実に四種ものステージが揃った[^1]ため、これ以降はあんまし追加する気はないです。**もしかしたらタイムワープが最後の追加になるかもしれません。**
[^1]:統合されている"こういう"形式のゲームでは最多
