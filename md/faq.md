...
何も考えずに決めているわけではなく、<strong class="strong large">理由があってこのようなルールにしています。</strong>
...
『検索して出てくる』ものは、<strong class="strong large">典拠そのもののページではなく、それらを引用しているサイト群を指しています。</strong>
...
いかに体裁が整っているサイトであったとしても、権利の侵害が行われているおそれのあるサイトをおめおめと参考にするわけにはまいりません。
