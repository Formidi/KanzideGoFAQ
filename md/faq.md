...
ジャンルの優先度に関しては以下の通りです。たまに<span id="exception">例外</span>が出る時もありますが、**基本的に開発側の裁量**といたします。

<foot-note for="exception">Lv3『魔剤』は「スラング」としている。以下の表を基準とするならば「飲食」に入りそうではあるが、そもそも『魔剤』という単語そのものが俗語であり、仮に「飲食」ジャンルとすると『魔剤』を俗語ではないものと見なすことになる</foot-note>
...
中には、辞書の単語・意味の内容を網羅したものを無断で転載しているサイトも存在します。<span class="small">（中には、許可を得ていないと堂々と公言されている方もいます）</span>
...
タイムワープを追加して実に<span id="stage">四種ものステージが揃った</span>ため、これ以降はあんまし追加する気はないです。**もしかしたらタイムワープが最後の追加になるかもしれません。**

<foot-note for="stage">統合されている"こういう"形式のゲームではキャラ最多…のはず</foot-note>
