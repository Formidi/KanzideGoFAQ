...
とりわけ高難易度のレベルにおいて、**配信者が求めていないときに視聴者が解答をコメントされている**といったケースをお見掛けすることがございます。

チャンネルのルール等にもよりますが、<strong class="strong large">解答する前にルールを確認したり、配信者へ確認を取っていただきますようお願い申し上げます。</strong>
