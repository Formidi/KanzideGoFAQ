...
ジャンルの優先度に関しては以下の通りです。たまに例外が出る時もありますが、**基本的に開発側の裁量**といたします。
...
特に『読みが捏造される』ことは他の問題に比べ脆弱性が高いですが、主に出典記載の有無・追記された日付を見て判断いたします。<span class="small">（漢字表記が追加される点に関しては本ゲームに対するデメリットが思い当たりません…）</span>

そのため、『[**鱣子**](https://formidi.github.io/KanzideGoFAQ/?p=memorandum)』など、**本ゲームが独断で慣用的な読みと判断しているケース**もございます。

</br>

いくつかの問題が生じているものの、検索して比較的容易に確認ができるということはそれだけで多くのデメリットに勝ると考えています。
...
## 【やめてほしい】新ステージの案を送りたい／新ステージを追加してほしい
スカイを追加して三種類が揃ったため、これ以降はあんまし追加する気はないです。**もしかしたらスカイが最後の追加になるかもしれません。**

<strong class="strong large">ステージをひとつ制作するだけでも莫大な時間、工数、労働コストが発生します。</strong>

何故受け付けていないかというと、**アイデア自体を否定しているわけではなく、本ゲームの世界観に他方の案を介入させたくないためです。**
この点だけは絶対に譲れませんので、何卒ご理解ください。
...
### 返信を行わないものの例
- 重要であると判断されていないもの
  - 最近では、**重要と判断したものに限り返信およびFAQ内の回答を行うようにしています。**
- 誤字脱字に関する修正などのご指摘
  - 毎回同じように対応していたらキリがないため、大変恐縮ではございますが反応しない場合が多いです。
- すでに同じ要望に対して回答しているもの
- 答えることが難しいもの
- `『●●の進捗はどうなっていますか？』` `『FAQの古い部分の更新を順次お願いしたい』`など、何かしらの開発、運営を催促するようなもの
  - 本ゲームは<span class="small">（一部プログラムを除いて）</span>個人で自由に作っているゲームです。お気持ちは分かりますが、こういったものは自分にとってかなりのプレッシャーになってしまうので、差し支えなければお控えいただけますと助かります。
- 個人で行うには途方もないような工数の要望であるもの
...
<strong class="strong large">何度も送ることによって回答されやすくなるといったことは一切ない</strong>ためご遠慮ください。
...
投稿がされたら逐一チェックをしているというわけではなく、問題作成の際に各必要なLvを検索し、少しずつ確認しております。
