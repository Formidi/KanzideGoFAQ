...
『肙』などの、基本と上級ジャンルをあわせ持った問題の際は、基本的に上級ジャンルが優先されます。

存在するかは分かりませんが、上級ジャンルの要素を2つ以上もつ場合は左上にあるものから優先されます。

例
- 『単位』かつ『字通訓』の場合、『単位』ジャンルになる
- 『則天文字』かつ『チュノム』の場合、『則天文字』ジャンルになる　`※あり得ない組み合わせ`
...
前提として、本ゲームで使用している典拠は **『検索して誰でもすぐに見つけられるから』** という便宜的な意味合いが強いです。
...
典拠のひとつであるzi.toolsも一部ページの訓読に誤植が確認できたり、コトバンクでもその辞書／本の当時の表記がそのまま載ってたりするので`(『鰐蜥蜴鱚』の「易」が「昜」と表記されている)`、突き詰めると何かしら人の手が加わってる以上、使用している典拠において完全無欠な信憑性というのは存在しません。

問題ごとに具体的な辞典の名前を出すといったことも行いませんので、**ルールの意義を勘違いして本ゲームにそのようなことは求めないでいただきたいです。**
...
- すでに同じ要望に対して回答しているもの
- 答えることが難しいもの
- `『●●の進捗はどうなっていますか？』` `『FAQの古い部分の順次更新をお願いしたい』`など、何かしらの開発、運営を催促するようなもの
